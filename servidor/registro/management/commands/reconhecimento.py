...
class Command(BaseCommand):
    ...
    def reconhecer_faces(self):
        ...
        if not treinamento:
            ...
            return
        model_path = os.path.join(settings.MEDIA_ROOT, treinamento.modelo.name) # Classificador Eigen.yml
        ...
        while True:
            ...
            for (x,y,l,a) in faces_detectadas:
                ...
                if funcionario:
                    cv2.putText(frame_redimensionado, str(funcionario.nome).strip("(),'"),(x,y + a + 30), font, 1, (0, 255, 0), 2)
                else:
                    cv2.putText(frame_redimensionado, "Nenhum user encontrado", (x, y + a + 30), font, 1,(0, 0, 255), 2)
